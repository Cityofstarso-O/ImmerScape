...
export class WebGL {
    constructor(canvas_) {
        this.api = canvas_.getContext("webgl2", {
            antialias: false,
        });
        ...
        this.u_textureLocation = gl.getUniformLocation(this.program, "u_texture");
        gl.uniform1i(this.u_textureLocation, 0);

        this.indexBuffer = gl.createBuffer();
        this.a_index = gl.getAttribLocation(this.program, "index");
